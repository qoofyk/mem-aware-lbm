...
compileFlags = -Wall -Wextra -Wnon-virtual-dtor -Wno-deprecated-declarations -DPLB_MAC_OS_X -std=c++11 -qopt-report5 -qopt-report-phase=vec -qopenmp-simd -xCORE-AVX2 #-fno-strict-aliasing -no-fma
