...
libraryPaths =
# Path to external libraries (other than Palabos)
includePaths = -I${HOME}/intel/vtune_amplifier_2019.6.0.602217/include
# Dynamic and static libraries (other than Palabos)
libraries    = ${HOME}/intel/vtune_amplifier_2019.6.0.602217/lib64/libittnotify.a
...
compileFlags = -Wall -Wextra -Wnon-virtual-dtor -Wno-deprecated-declarations -DPLB_MAC_OS_X -std=c++11 -qopt-report5 -qopt-report-phase=vec -qopenmp-simd -D_OPENMP -qopenmp #-fno-strict-aliasing -no-fma
