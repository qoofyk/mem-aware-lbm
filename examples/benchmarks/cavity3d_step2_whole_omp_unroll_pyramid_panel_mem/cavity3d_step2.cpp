...
struct MyException3 : public exception {
  const char * what () const throw () {
    return "ykPanel_len < Nz && Nz % ykPanel_len != 0, Not Divisible";
  }
};
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        // global::argv(8).read(ykPanel_len);
        ...
        // if (ykPanel_len < Nz && Nz % ykPanel_len != 0)  throw MyException3();
    }
    ...
    else pcout << "boundaryCondition nullptr\n";
